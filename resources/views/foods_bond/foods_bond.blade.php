<x-template title="Food's Bond 〜食がつなぐキズナ〜" css="foods_bond.css">
    ...
    <main class="flex flex-col justify-center items-start pt-20 md:pt-0 md:pl-[240px] min-h-[100dvh] @switch(date('m')) @case(1)winter @break @case(2)winter @break @case(3)spring @break @case(4)spring @break @case(5)spring @break @case(6)summer @break @case(7)summer @break @case(8)summer @break @case(9)autumn @break @case(10)autumn @break @case(11)autumn @break @case(12)winter @break @endswitch">
        <div class="flex flex-col md:flex-row justify-center items-center p-4">
            ...
            <div class="w-full md:w-1/2 p-4">
                <div class="w-full bg-white p-4 rounded-lg">
                    ...
                    <p>2025年も引き続き開催！毎月第2週火曜日・木曜日に教職支援センター前と三翠ホール前にキッチンカーがやってくる！！！</p>
                </div>
            </div>
        </div>
        <div class="flex flex-col w-full justify-center items-center p-4 gap-6">
            ...
            <div class="hidden flex-col w-full justify-center items-center bg-white rounded-lg border border-blue-900">
            ...
            <div id="July" class="hidden flex-col w-full justify-center items-center bg-white rounded-lg border border-blue-900">
                    ...
                    <div class="flex flex-col md:flex-row justify-center items-center max-w-full md:max-w-[50%] p-4 gap-4">
                        <div class="edu-center flex flex-col items-center p-4 bg-pink-200 border border-pink-400 rounded-lg w-full">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.visiter-card shopName="クレープショップSARU" shopImg="saru.JPG" instagram="osaruno_himeno" targetDate="11/5(Tue)" appeal="クレープ🍓" />
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(19)" targetDate="11/7(Thu)" appeal="カラフルだんご🍡" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                        ...
                        <div class="sansui-hole flex flex-col items-center w-full p-4 bg-green-200 border border-green-400 rounded-lg">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(22)" targetDate="11/5(Tue)" appeal="ホットサンド🥪" />
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                    ...
                    <div class="flex flex-col md:flex-row justify-center items-center max-w-full md:max-w-[50%] p-4 gap-4">
                        <div class="edu-center flex flex-col items-center p-4 bg-pink-200 border border-pink-400 rounded-lg w-full">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(14)" targetDate="12/10(Tue)" appeal="コロッケ🥔" />
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(42)" targetDate="12/12(Thu)" appeal="コーヒー☕️" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                        ...
                        <div class="sansui-hole flex flex-col items-center w-full p-4 bg-green-200 border border-green-400 rounded-lg">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.visiter-card shopName="ワールドフーズ" shopImg="worldfoods.png" instagram="worldfoods4411" targetDate="12/10(Tue)" appeal="プリーツドーナツ等" />
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(20)" targetDate="12/12(Thu)" appeal="ホットドッグ🌭" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                    ...
                    <div class="flex flex-col md:flex-row justify-center items-center max-w-full md:max-w-[50%] p-4 gap-4">
                        <div class="edu-center flex flex-col items-center p-4 bg-pink-200 border border-pink-400 rounded-lg w-full">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(9)" targetDate="1/7(Tue)" appeal="佐世保バーガー🍔" />
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.visiter-card shopName="クラッフェ" shopImg="kuraffe.JPG" instagram="kitchenkuraffe" targetDate="1/9(Thu)" appeal="だし巻きバーガー🥚" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="relative swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(18)" targetDate="1/7(Tue)" appeal="クレープ💐" />
                                        <div class="absolute top-0 left-0 flex justify-center items-center w-full h-full z-10" style="background-color: rgba(0, 0, 0, 0.8)">
                                            <p class="text-white text-2xl z-20 text-center">諸事情により<br>出店中止</p>
                                        </div>
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(53)" targetDate="1/9(Thu)" appeal="はちみつカステラ🍯" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                    ...
                    <div class="flex flex-col md:flex-row justify-center items-center max-w-full md:max-w-[50%] p-4 gap-4">
                        ...
                        <div class="sansui-hole flex flex-col items-center w-full p-4 bg-green-200 border border-green-400 rounded-lg">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="relative swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.visiter-card shopName="ノムズキッチン" shopImg="nomuzu.jpg" instagram="nomu.s_kitchen" targetDate="4/15(Tue)" appeal="ホットドッグ🌭" />
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.visiter-card shopName="小春や" shopImg="koharuya.JPG" instagram="ko_ha_ru_ya" targetDate="4/17(Thu)" appeal="和ツイーツ" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                    ...
                    <div class="flex flex-col md:flex-row justify-center items-center max-w-full md:max-w-[50%] p-4 gap-4">
                        <div class="edu-center flex flex-col items-center p-4 bg-pink-200 border border-pink-400 rounded-lg w-full">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="relative swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(11)" targetDate="5/13(Tue)" appeal="キーマカレー🍛" />
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(42)" targetDate="5/15(Thu)" appeal="コーヒー☕️" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                        ...
                        <div class="sansui-hole flex flex-col items-center w-full p-4 bg-green-200 border border-green-400 rounded-lg">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="relative swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(36)" targetDate="5/13(Tue)" appeal="クレープ🐈" />
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                    ...
                    <div class="flex flex-col md:flex-row justify-center items-center max-w-full md:max-w-[50%] p-4 gap-4">
                        <div class="edu-center flex flex-col items-center p-4 bg-pink-200 border border-pink-400 rounded-lg w-full">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="relative swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(22)" targetDate="6/10(Tue)" appeal="ホットサンド🥪" />
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.visiter-card shopName="水色キッチンカー" shopImg="mizuiro.JPG" instagram="mizuiro.kitchencar" targetDate="6/12(Thu)" appeal="タピオカドリンク" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                        ...
                        <div class="sansui-hole flex flex-col items-center w-full p-4 bg-green-200 border border-green-400 rounded-lg">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="relative swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(53)" targetDate="6/10(Tue)" appeal="はちみつカステラ🍯" />
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                    ...
                    <div class="flex flex-col md:flex-row justify-center items-center max-w-full md:max-w-[50%] p-4 gap-4">
                        <div class="edu-center flex flex-col items-center p-4 bg-pink-200 border border-pink-400 rounded-lg w-full">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(18)" targetDate="10/7(Tue)" appeal="花束みたいなクレープ💐" />
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(14)" targetDate="10/9(Thu)" appeal="コロッケ🥔" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                        ...
                        <div class="sansui-hole flex flex-col items-center w-full p-4 bg-green-200 border border-green-400 rounded-lg">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.visiter-card shopName="Nano." shopImg="nano.JPG" instagram="n.ano_cafe_kc" targetDate="10/7(Tue)" appeal="からあげ🍗&ソフトクリーム🍦" />
                                    </div>
                                    <div class="relative swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(9)" targetDate="10/9(Thu)" appeal="佐世保バーガー🍔" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                    ...
                    <div class="flex flex-col md:flex-row justify-center items-center max-w-full md:max-w-[50%] p-4 gap-4">
                        <div class="edu-center flex flex-col items-center p-4 bg-pink-200 border border-pink-400 rounded-lg w-full">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.visiter-card shopName="LbE" shopImg="Lbe.jpg" instagram="lbe_397" targetDate="11/11(Tue)" appeal="ホットドッグ🌭" />
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(17)" targetDate="11/13(Thu)" appeal="きゅうりタコス🥒" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                        ...
                        <div class="sansui-hole flex flex-col items-center w-full p-4 bg-green-200 border border-green-400 rounded-lg">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(36)" targetDate="11/11(Tue)" appeal="クレープ🐈" />
                                    </div>
                                    <div class="relative swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.visiter-card shopName="ノムズキッチン" shopImg="nomuzu.jpg" instagram="nomu.s_kitchen" targetDate="11/13(Thu)" appeal="ホットドッグ🌭" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                    ...
                    <div class="flex flex-col md:flex-row justify-center items-center max-w-full md:max-w-[50%] p-4 gap-4">
                        <div class="edu-center flex flex-col items-center p-4 bg-pink-200 border border-pink-400 rounded-lg w-full">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(16)" targetDate="12/11(Thu)" appeal="大豆ミートからあげ🍗" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                        ...
                        <div class="sansui-hole flex flex-col items-center w-full p-4 bg-green-200 border border-green-400 rounded-lg">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(18)" targetDate="12/11(Thu)" appeal="花束みたいなクレープ💐" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                    ...
                    <div class="flex flex-col md:flex-row justify-center items-center max-w-full md:max-w-[50%] p-4 gap-4">
                        <div class="edu-center flex flex-col items-center p-4 bg-pink-200 border border-pink-400 rounded-lg w-full">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(18)" targetDate="1/6(Tue)" appeal="花束みたいなクレープ💐" />
                                    </div>
                                    <div class="relative swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(9)" targetDate="1/8(Thu)" appeal="佐世保バーガー🍔" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
                        ...
                        <div class="sansui-hole flex flex-col items-center w-full p-4 bg-green-200 border border-green-400 rounded-lg">
                            ...
                            <div class="swiper flipSwiper max-w-full md:max-w-[350px]">
                                <div class="swiper-wrapper w-full">
                                    <div class="relative swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(9)" targetDate="1/6(Tue)" appeal="佐世保バーガー🍔" />
                                    </div>
                                    <div class="swiper-slide p-4 bg-white rounded-lg border border-blue-900">
                                        <x-foods_bond.shop-card :data="$shop_lists->find(18)" targetDate="1/8(Thu)" appeal="花束みたいなクレープ💐" />
                                    </div>
                                </div>
                                <div class="swiper-button-next"></div>
                                <div class="swiper-button-prev"></div>
